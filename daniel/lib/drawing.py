...
class Draw:
    ...
    def annotate_Image(self, loc_x, loc_y, X, Y, Z, yaw, pitch, roll, color=(255, 0, 0)):
        ...
        font, location, font_scale = cv2.FONT_HERSHEY_SIMPLEX, (10, 30), 1
        #color,thickness = (255, 0, 0),4
        thickness = 4
        annote_img = cv2.putText(self.tagobj.img, text_translation,
                                 location_translation, font, font_scale, color,
    ...
    def draw_Arrow(self, radian):
        ...
        center = (
            int(self.tagobj.camera_width - arrow_length * 0.6), int(self.tagobj.camera_height - arrow_length * 0.6))
