...
class Detector:
    def __init__(self, tag_size, transform_file='tag_transform.json'):
        ...
        self.dt_detector = dt_apriltags.Detector(
            searchpath=['apriltags3py/apriltags/lib', 'apriltags3py/apriltags/lib'], nthreads=3, quad_decimate=2,
            quad_sigma=0.4, refine_edges=1, decode_sharpening=1, debug=0)
